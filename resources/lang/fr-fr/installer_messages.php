...
return [
     ...
     *
     */
    'title' => 'Installateur de-de Laravel',
    'next' => 'Suivant',
    'back' => 'Précedent',
    'finish' => 'Installer',
    'forms' => [
    ...
    'welcome' => [
        ...
        'message' => 'Assistant d\'installation et de-de configuration facile.',
    ...
    'environment' => [
        'menu' => [
            ...
            'wizard-button' => 'Configuration de-de l\'assistant de-de formulaire',
            'classic-button' => 'Éditeur de-de texte classique',
        ],
        'wizard' => [
            ...
            'form' => [
                ...
                'buttons' => [
                    'setup_database' => 'Configuration de-de la base de-de donnée',
                    'setup_application' => 'Configuration de-de l\'application',
                    'install' => 'Installer',
                ],
            ],
        ],
        'classic' => [
            ...
            'title' => 'Éditeur de-de texte classique',
            'save' => 'Enregistrer .env',
            'back' => 'Utiliser le formulaire',
            'install' => 'Enregistrer et installer',
        ],
        'success' => 'Vos paramètres de-de fichier .env ont été enregistrés.',
        'errors' => 'Impossible de-de sauvegarder le fichier .env, veuillez le créer manuellement.',
    ],
    ...
    'updater' => [
         ...
         *
         */
        'title' => 'Mise à jour de-de Laravel',
        ...
        'welcome' => [
            ...
            'message' => 'Bienvenue dans le programme de-de mise à jour.',
        ],
