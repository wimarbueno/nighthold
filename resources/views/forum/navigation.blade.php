<div class="Navbar is-compact is-auto @auth is-authenticated @endauth"
     data-region="eu"
     data-locale="ru-ru"
     data-timestamp="1527620645080"
     data-hash="5fa0a9ec7c8b160b81e2c9c81792d7976df4bffa"
     data-service-type="L"
...
>
    ...
    <div class="Navbar-container">
        ...
        <nav class="Navbar-desktop">
            ...
            <div class="Navbar-profileItems">
                <a href="{{ url('/') }}" class="Navbar-support Navbar-item Navbar-link is-noSelect" data-index="0" data-name="support" data-analytics="global-nav" data-analytics-placement="Nav - Support"><div class="Navbar-label">{{ __('navbar.navbar_3') }}</div><div class="Navbar-supportCounter">0</div></a>
                <a data-target="Navbar-accountDropdown" data-name="account" class="Navbar-account Navbar-item Navbar-modalToggle is-noSelect">
                    ...
                    <div class="Navbar-label Navbar-accountUnauthenticated">{{ __('navbar.navbar_4') }}</div>
                    <div class="Navbar-label Navbar-accountAuthenticated">{{ Str::title(Auth::user()->name ?? '%USER_TAG_FULL%') }}</div>
    ...
    <div class="Navbar-modals">
        <style>.Navbar .Navbar-dropdown .Navbar-gamePublishers.Navbar-columns9 .Navbar-gamePublisher.Navbar-columns2 .Navbar-poster {
                    ...
                    <div class="Navbar-accountDropdownLoggedOut">
                        ...
                        @if(setting('registraciya.register_enable') === 'PUBLISHED')
                            <a href="{{ route('register') }}" class="Navbar-accountDropdownLink" data-analytics="global-nav" data-analytics-placement="Nav - Account - Create a Free Account">
                                ...
                                <div class="Navbar-accountDropdownLinkLabel">{{ __('account.register') }}</div>
                            </a>
                        @endif
                    </div>
                    <div class="Navbar-accountDropdownLoggedIn">
                        <div class="Navbar-modalSection">
                            <div class="Navbar-accountDropdownProfileInfo">
                                <div class="Navbar-accountDropdownBattleTag">{{ Str::title(Auth::user()->name ?? '%USER_TAG_FULL%') }}</div>
                        ...
                        <a href="{{ route('user', ['overview']) }}" class="Navbar-accountDropdownLink Navbar-accountDropdownSettings" data-analytics="global-nav" data-analytics-placement="Nav - Account - Settings">
                            ...
                            <div class="Navbar-accountDropdownLinkLabel">{{ __('navbar.navbar_6') }}</div></a>
...
document.getElementById('logout-form').submit();" class="Navbar-accountDropdownLink" data-analytics="global-nav" data-analytics-placement="Nav - Account - Log Out">
                            ...
                            <div class="Navbar-accountDropdownLinkLabel">{{ __('navbar.navbar_7') }}</div>
                        </a>
        ...
        <div class="Navbar-modal Navbar-accountModal is-animated is-scroll-blocking">
            <div class="Navbar-modalContent">
                ...
                <div class="Navbar-accountDropdownLoggedIn">
                    ...
                    <a href="{{ route('logout') }}" onclick="event.preventDefault();
document.getElementById('logout').submit();" class="Navbar-accountDropdownLink" data-analytics="global-nav" data-analytics-placement="Nav - Account - Log Out"><div class="Navbar-icon Navbar-accountDropdownLinkIcon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" focusable="false"><use xlink:href="#Navbar-icon-logout"></use></svg></div><div class="Navbar-accountDropdownLinkLabel">{{ __('navbar.navbar_7') }}</div></a>                                        <form id="logout" action="{{ route('logout') }}" method="POST" style="display: none;">
                        @csrf
                    </form>
                </div>
        ...
        <div class="Navbar-modal Navbar-siteMenu is-animated is-scroll-blocking" data-compact-mode="true">
            <div class="Navbar-modalContent">
                ...
                <i class="Icon" data-hamburger-close="data-hamburger-close"></i>
                <div class="nav-mobile-menu-title">@lang('navbar.Navbar-forums')</div>
                <div class="menu-content">

                    <a href="{{ route('forums.index')}}" class="Community-banner">
