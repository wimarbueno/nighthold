...
<form class="step__form step__block" action="/account/creation/flow/create-full/step/set-battletag" method="post" id="flow-form" enctype="multipart/form-data" novalidate>
    ...
    <div class="step__field step__form__block">
        <input class="step__input" valid="true" id="capture-username" data-capture-id="username" name="username" placeholder="@lang('account.create_step_3_7')" type="text" minlength="3" autocomplete="username" maxlength="254" pattern="^[a-zA-Z ]+$"/>
    ...
    @enderror
    <div class="step__field step__form__block">
        <input class="step__input" valid="true" id="capture-name" data-capture-id="name" name="name" placeholder="@lang('account.create_step_6_3', ['name' => setting('site.title')])Tag" type="text" autocomplete="nickname" maxlength="30" pattern="([\u0041-\u005a\u0061-\u007a\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u017e\u0180-\u0188\u0190-\u0198\u01c0-\u0217\u0030-\u0039]{3,12})|([\u0400-\u04ff\u0500-\u052f\u0030-\u0039]{3,12})" />
        <span class="step__field__indicator"></span>
    </div>
