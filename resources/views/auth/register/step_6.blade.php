...
<h1 class="step__title step__block">@lang('account.create_step_5_1', ['name' => setting('site.title')])Tag</h1>
...
<form class="step__form step__block" action="/account/creation/flow/create-full/step/set-battletag" method="post" id="flow-form" enctype="multipart/form-data" novalidate>
    ...
    <div class="step__field step__form__block">
        <input class="step__input" valid="true" id="capture-battletag" data-capture-id="battletag" name="battletag" placeholder="@lang('account.create_step_5_3', ['name' => setting('site.title')])Tag" type="text" autocomplete="nickname" maxlength="30" pattern="([\u0041-\u005a\u0061-\u007a\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u017e\u0180-\u0188\u0190-\u0198\u01c0-\u0217\u0030-\u0039]{3,12})|([\u0400-\u04ff\u0500-\u052f\u0030-\u0039]{3,12})" />
