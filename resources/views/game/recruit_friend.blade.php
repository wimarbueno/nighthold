                                                        ...
                                                        <div class="Raf-RewardCard-link">
                                                            <div class="Raf-RewardCard-background" style="background-image: url({{ asset('v3/assets/RAF_recruiter_rewards_background.jpg') }});">
                                                                <div class="Raf-RewardCard-foregroundWrapper">
                                                                    <div class="Raf-RewardCard-foreground" style="background-image: url({{ asset('v3/assets/RAF_recruiter_rewards_month_1.png') }});"></div></div><div class="Raf-RewardCard-border"></div><div class="Raf-RewardCard-breakout" style="background-image: url({{ asset('v3/assets/RAF_recruiter_rewards_month_1_outer.png') }});"></div></div>
                                                    ...
                                                    <a role="button" tabindex="0" class="ControlledModalToggle Raf-RewardCard-modal-toggle">
                                                        <div class="Raf-RewardCard-link">
                                                            <div class="Raf-RewardCard-background" style="background-image: url({{ asset('v3/assets/RAF_recruiter_rewards_background.jpg') }});">
                                                                <div class="Raf-RewardCard-foregroundWrapper">
                                                                    <div class="Raf-RewardCard-foreground" style="background-image: url({{ asset('v3/assets/RAF_recruiter_rewards_month_1.png') }});"></div></div><div class="Raf-RewardCard-border"></div><div class="Raf-RewardCard-breakout" style="background-image: url({{ asset('v3/assets/RAF_recruiter_rewards_month_1_outer.png') }});"></div></div>
                                                            <div class="Raf-RewardCard-rewardName">5 бонусов</div>
                                                    ...
                                                    <a role="button" tabindex="0" class="ControlledModalToggle Raf-RewardCard-modal-toggle">
                                                        <div class="Raf-RewardCard-link">
                                                            <div class="Raf-RewardCard-background" style="background-image: url({{ asset('v3/assets/RAF_recruiter_rewards_background.jpg') }});">
                                                                <div class="Raf-RewardCard-foregroundWrapper">
                                                                    <div class="Raf-RewardCard-foreground" style="background-image: url({{ asset('v3/assets/RAF_recruiter_rewards_month_1.png') }});"></div></div><div class="Raf-RewardCard-border"></div><div class="Raf-RewardCard-breakout" style="background-image: url({{ asset('v3/assets/RAF_recruiter_rewards_month_1_outer.png') }});"></div></div>
                                                            <div class="Raf-RewardCard-rewardName">Прогулачная ракета</div>
                                                            <div class="Raf-RewardCard-subtitle">За трех друзей отыгравшие по 24 часа</div>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
