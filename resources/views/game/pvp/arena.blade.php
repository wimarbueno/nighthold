                            ...
                            <div class="SortTable-head">
                                @if($type === '2v2')
                                    <div class="SortTable-row">
                                        ...
                                        <div class="SortTable-col SortTable-label" data-priority="6" media-wide="!hide" queryselectoralways="0 1" media-original="SortTable-col SortTable-label">
                                            <div class="SortTable-labelOuter">
                                                <div class="SortTable-labelInner">
                                            ...
                                            <div class="SortTable-row">
                                                <div class="SortTable-col SortTable-data align-center text-nowrap">
                                                    <div class="flex flex-align-center flex-justify-center">
                                                        <a class="Link" data-tooltip="pvp-tier-tooltip-{{ Utils::imageRating($item->team_member->rating)['tier'] }}" queryselectoralways="0 37">
                                                            <div class="List">
                                                                <div class="List-item"><img src="{{ Utils::imageRating($item->team_member->rating)['images'] }}" style="max-width: 32px; margin-right: 5px;"></div>
                                                                <div class="List-item">
                                                                    {{ $item->team_member->rating }}
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="SortTable-col SortTable-data text-nowrap align-center color-status-success" data-value="{{ $loop->iteration }}" media-wide="!hide" queryselectoralways="0 1" media-original="SortTable-col SortTable-data text-nowrap align-center color-status-success">{{ $loop->iteration }}</div>
                                            </div>
                                        @else
                                            <div class="SortTable-row">
