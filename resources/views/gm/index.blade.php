                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="py-1">
                                            ...
                                            <h3 class="text-warning">{{ $tickets->where('type', 0)->count() }}</h3>
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="py-1">
                                            ...
                                            <h3 class="text-success">{{ $tickets->where('type', 1)->count() }}</h3>
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <div class="py-1">
                                            ...
                                            <h3 class="text-danger">{{ $tickets->where('type', 2)->count() }}</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" cellspacing="0" id="tickets-table">
                                ...
                                @empty
                                    <tr><td> Новых тикетов не найдено</td></tr>
                                @endforelse
                                </tbody>
                            </table>
                        </div>
